---
article_id: KTC-08-03
title: "Lubang dan Notch pada Kaca: Data yang Harus Disetujui"
slug: "data-lubang-notch-kaca-cubicle"
...
final_route: "/artikel/data-lubang-notch-kaca-cubicle.html"
...
# Lubang dan Notch pada Kaca: Data yang Harus Disetujui

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lubang dan Notch pada Kaca: Data yang Harus Disetujui”
...
- **Scope boundary:** Documentation only; limits from fabricator/standard
- **Final public route:** `/artikel/data-lubang-notch-kaca-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lubang dan Notch pada Kaca: Data yang Harus Disetujui**.
...
- `KTC-08-01` → `/artikel/kapan-memerlukan-template-kaca.html` — Template Kaca: Kapan Ukuran Gambar Tidak Cukup?
- `KTC-08-02` → `/artikel/memilih-edgework-kaca-cubicle.html` — Jenis Edgework untuk Panel dan Pintu Cubicle
- `KTC-08-04` → `/artikel/urutan-proses-kaca-cubicle.html` — Urutan Tempering, Laminating, Coating, dan Fabrication
...
- **Tie back to this article:** Keep the explanation specific to “Lubang dan Notch pada Kaca: Data yang Harus Disetujui”.
