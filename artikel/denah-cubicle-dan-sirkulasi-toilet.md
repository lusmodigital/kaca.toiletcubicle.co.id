---
article_id: KTC-04-05
title: "Urutan Denah Cubicle, Wastafel, dan Sirkulasi"
slug: "denah-cubicle-dan-sirkulasi-toilet"
description: "Plan doors, clearances, privacy, circulation, and accessible compartments"
status: outline
publication_date: "2026-01-13"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: KTC-04
primary_intent: "Coordinate restroom layout"
reader_community: "Toiletcubicle.co.id"
reader_address: "Kawan Toiletcubicle.co.id"
final_route: "/artikel/denah-cubicle-dan-sirkulasi-toilet.html"
...
# Urutan Denah Cubicle, Wastafel, dan Sirkulasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Urutan Denah Cubicle, Wastafel, dan Sirkulasi”
- **Reader and situation:** Plan doors, clearances, privacy, circulation, and accessible compartments
- **Reader outcome:** Plan doors, clearances, privacy, circulation, and accessible compartments
- **Primary intent:** Coordinate restroom layout
...
- **Scope boundary:** Spatial planning; plumbing design excluded
- **Final public route:** `/artikel/denah-cubicle-dan-sirkulasi-toilet.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Urutan Denah Cubicle, Wastafel, dan Sirkulasi**.
...
- **Exact Markdown to insert:** `![Ilustrasi WASTAFEL](/wp-content/uploads/2021/07/WASTAFEL.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `WASTAFEL` as relevant content media; no pixels were inspected.
...
- `KTC-04-03` → `/artikel/mengurangi-celah-pandang-cubicle.html` — Mengurangi Celah Pandang pada Cubicle Kaca
- `KTC-04-04` → `/artikel/brief-cubicle-toilet-aksesibel.html` — Merencanakan Cubicle Toilet Aksesibel
- `KTC-04-06` → `/artikel/checklist-shop-drawing-cubicle-kaca.html` — Checklist Review Shop Drawing Cubicle Kaca
...
- **Tie back to this article:** Keep the explanation specific to “Urutan Denah Cubicle, Wastafel, dan Sirkulasi”.
