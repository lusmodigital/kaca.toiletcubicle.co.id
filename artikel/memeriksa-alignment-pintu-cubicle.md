---
article_id: KTC-09-03
title: "Memeriksa Alignment, Celah, dan Gerak Pintu"
slug: "memeriksa-alignment-pintu-cubicle"
...
date_modified: null
parent_topic: KTC-09
primary_intent: "Verify function and geometry"
reader_community: "Toiletcubicle.co.id"
reader_address: "Kawan Toiletcubicle.co.id"
final_route: "/artikel/memeriksa-alignment-pintu-cubicle.html"
...
# Memeriksa Alignment, Celah, dan Gerak Pintu

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Memeriksa Alignment, Celah, dan Gerak Pintu”
...
- **Primary intent:** Verify function and geometry
...
- **Scope boundary:** Functional check; tolerances require approved drawing
- **Final public route:** `/artikel/memeriksa-alignment-pintu-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memeriksa Alignment, Celah, dan Gerak Pintu**.
...
- `KTC-09-01` → `/artikel/rencana-handling-panel-kaca-proyek.html` — Cara Menyimpan dan Memindahkan Panel Kaca di Proyek
- `KTC-09-02` → `/artikel/urutan-inspeksi-pemasangan-cubicle.html` — Urutan Inspeksi Pemasangan Cubicle Kaca
- `KTC-09-04` → `/artikel/sealant-gasket-cubicle-kaca.html` — Sealant dan Gasket pada Cubicle Kaca
- `KTC-09-05` → `/artikel/punch-list-cubicle-kaca.html` — Punch List Cubicle Kaca Sebelum Serah Terima
...
- **Tie back to this article:** Keep the explanation specific to “Memeriksa Alignment, Celah, dan Gerak Pintu”.
